...
from app.api.exceptions.http_exceptions import Unauthorized, BadRequest
...
class AuthUtils:
    ...
    def verify_token(token: str, token_type: str = "access") -> TokenData:
        ...
        try:
            ...
            raise BadRequest(enum_error=HTTPErrorMessage.USER_UNAUTHORIZED)  # pylint: disable=W0707
